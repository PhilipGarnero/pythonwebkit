...
#ifndef SearchPopupMenuDFB_h
#define SearchPopupMenuDFB_h
...
class SearchPopupMenuDFB : public SearchPopupMenu {
public:
    SearchPopupMenuDFB(PopupMenuClient*);
...
private:
    RefPtr<PopupMenuDFB> m_popup;
};

}

#endif // SearchPopupMenuDFB_h
