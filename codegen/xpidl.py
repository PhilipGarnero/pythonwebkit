...
class IDLParser(object):
    ...
    def t_IDENTIFIER(self, t):
        r'unsigned\ int|unsigned\ long\ long|unsigned\ short|unsigned\ long|long\ long|[A-Za-z][A-Za-z_0-9]*'
    ...
    def t_CPPCOMMENT(self, t):
        r'\#\ (?P<line>[0-9]+)\ (?P<comment>[".*])[^\n]+'
        t.value = t.lexer.lexmatch.group('comment')
        return t
    ...
    def p_module_comment(self, p):
        """module : CPPCOMMENT module"""
        p[0] = p[2]
    ...
    def p_productions_comment(self, p):
        """productions : CPPCOMMENT productions """
        p[0] = p[2]
